...
2026马年春节几天实在无聊，通过和Claude Code来回协作，从零构建一个完整的 Go 语言 AI Agent 框架mini-agent-go，完成整个设计、实现、调试、重构。最终的成果是一个真正可以投入使用的"数字员工"系统：它能调用工具、自主完成任务、记忆你的偏好、定时汇报工作，甚至通过即时通讯跟你聊天。
